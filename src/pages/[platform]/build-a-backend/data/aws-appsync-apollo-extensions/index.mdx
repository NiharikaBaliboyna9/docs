...
You can set up Amplify Data using Amplify CLI. To get started, see [Set up Data](/[platform]/swift/build-a-backend/data/set-up-data/). Once you have deployed your backend and created the `amplify_outputs.json`, you can use Amplify library to read and retrieve your configuration values with the following steps:
